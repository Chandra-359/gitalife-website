...
import { EVENT, LINEUP, PRICE_PHASES, TIERS } from "@/data/bhajanClubbing";
...
function eventJsonLd() {
  return {
    ...
    // One offer per suggested-donation phase — early bird carries its deadline.
    offers: PRICE_PHASES.map((phase) => ({
      "@type": "Offer",
      name: `${TIERS[0].name} — ${phase.label} (suggested donation)`,
      price: String(phase.amountUsd),
      priceCurrency: "USD",
      ...(phase.endsAtIso ? { priceValidUntil: phase.endsAtIso } : {}),
