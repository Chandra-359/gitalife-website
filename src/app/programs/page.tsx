 ...
 *
 * The interactive split-view map + program list, migrated from the homepage.
 * Fetches all programs from PostgreSQL via Prisma at request time,
 * serializes them, and passes them to the client-side SplitView.
 */
...
export const metadata: Metadata = {
  title: "Programs & Map — Gita Life NYC",
  description:
    "Explore upcoming programs and find events near you on the interactive map.",
};
